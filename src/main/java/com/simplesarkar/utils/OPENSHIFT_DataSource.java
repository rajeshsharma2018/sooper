...
public class OPENSHIFT_DataSource {
	...
	public class DataSource {
	    ...
	    public static String pwd = System.getenv("${OPENSHIFT_MYSQL_DB_PASSWORD}");
	  ...
	  //  public  static final String DB_URL =  "mysql://adminHUHrxU6:BxGx9GzAJyCW@56ce782b89f5cf67ce000171-simplesarkar.rhcloud.com:62616/web";
	    ...
	    //	return DataSource.getInstance("root", "rajesh",
	    	...
	    	return DataSource.getInstance(name, pwd,DB_URL, "com.mysql.jdbc.Driver");
	    }
