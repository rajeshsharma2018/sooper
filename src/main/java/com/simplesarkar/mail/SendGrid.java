...
import com.simplesarkar.mail.SendGridException;
...
public class SendGrid {
	...
	final static Logger log = Logger.getLogger(SendGrid.class);

	
    private static final String VERSION = "2.2.2";
    private static final String USER_AGENT = "sendgrid/" + VERSION + ";java";

    private static final String PARAM_TO = "rajeshsharmaa@gmail.com";
    private static final String PARAM_TONAME = "Rajesh Sharma";
    private static final String PARAM_CC = "cc[]";
    private static final String PARAM_BCC = "bcc[]";

    private static final String PARAM_FROM = "support@simplesarkar.com";
    private static final String PARAM_FROMNAME = "SimpleSarkar";
    private static final String PARAM_REPLYTO = "support@simplesarkar.com";
    private static final String PARAM_SUBJECT = "Welcome To SimpleSarkar";
    ...
    public static void main(String args[]){
    	...
    	email.setFrom("support@simplesarkar.com");
    	email.setFromName(PARAM_FROMNAME);
    	email.setReplyTo(PARAM_REPLYTO);
    	email.setSubject(PARAM_SUBJECT);
    	email.addTo("rajeshsharmaa@gmail.com");
    	email.setText("this is the body for ttest");
    	 email.addHeader(PARAM_HEADERS, "");
    	 
    	 
    	 
    	
    	String[] emailArr = new String[1];
    	emailArr[0] = "rajeshsharmaa@gmail.com";
    	 
    	email.setTo(emailArr);
    	 
    	SendGrid sg = new SendGrid("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");
    	email.addHeader("from", "support@simplesarkar.com");
